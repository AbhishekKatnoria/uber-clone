...
export default function Welcome() {
  ...
  const lastSlideIndex = activeIndex === onboarding.length - 1;
  return (
    <SafeAreaView className="flex h-full bg-white items-center justify-between">
        ...
        {onboarding?.map((item, index) => (
          <View key={index} className="flex justify-center items-center mt-3">
            <Image
              ...
              resizeMode="contain"
            />
            <View className="flex flex-row justify-center items-center mt-12 text-black">
      ...
      <CustomButton
        title={lastSlideIndex ? "Get Started" : "Next"}
        onPress={() =>
          lastSlideIndex
